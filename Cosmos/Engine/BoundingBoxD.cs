...
namespace Cosmos.Engine
{
    public struct BoundingBoxD : IEquatable<BoundingBoxD>
    {
        ...
        private static readonly Vector3D MaxVector3 = new Vector3D(double.MaxValue);
        private static readonly Vector3D MinVector3 = new Vector3D(double.MinValue);
        ...
        /// </summary>
        /// <param name="points">
        /// The list of Vector3D instances defining the point cloud to bound.
        /// </param>
        ...
        public static BoundingBoxD CreateFromPoints(IEnumerable<Vector3D> points)
        {
            ...
            bool empty = true;
            Vector3D minVec = MaxVector3;
            Vector3D maxVec = MinVector3;
            foreach (Vector3D ptVector in points)
            {
            ...
            return new BoundingBoxD(minVec, maxVec);
        }
        ...
        {
            Vector3D corner = new Vector3D(sphere.Radius);
        ...
        {
            return (obj is BoundingBoxD) && Equals((BoundingBoxD)obj);
        }
