...
namespace Cosmos.Engine
{
    ...
    public static class MathHelperD
    {
        ...
        internal static readonly double MachineEpsilondouble = GetMachineEpsilondouble();
        ...
        internal static bool WithinEpsilon(double doubleA, double doubleB)
        {
            return Math.Abs(doubleA - doubleB) < MachineEpsilondouble;
        }
        ...
        /// (That is, the largest double, e,  where e == 0.0f is true.)
        /// </summary>
        private static double GetMachineEpsilondouble()
        {
